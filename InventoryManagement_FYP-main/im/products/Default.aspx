...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div class="w3-container">
        <asp:Button Text="Add IT-asset" runat="server" ID="btnAdd" CssClass="w3-button w3-border w3-green" Width="150px" OnClick="btnAdd_Click" />
    ...
    <div class="w3-row-padding w3-margin-bottom w3-light-grey w3-border" style="margin-left: 20px; margin-right: 20px; margin-top: 20px;" runat="server">
        <div class="w3-container">
            <h2 class="w3-text-black"><strong>IT-assets</strong></h2>
