<%@ Page Title="" Language="C#" MasterPageFile="~/im/MasterPage.master" AutoEventWireup="true" CodeFile="addProduct.aspx.cs" Inherits="im_products_addProduct" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <header class="w3-container" style="padding-top: 22px">
        <h3><b><i class="fa fa-shopping-basket"></i>&nbsp;It-assets</b> <small style="font-size: x-small;">Manage</small></h3>
    </header>
    ...
    <div id="divForm" class="w3-row-padding w3-margin-bottom w3-light-grey w3-border" style="margin-left: 20px; margin-right: 20px; margin-top: 20px;" runat="server">
        <div class="w3-container">
            <h2 class="w3-text-black"><strong>Add new It-asset</strong></h2>
            ...
            <p>
                <label class="w3-text-black"><b>Asset Name</b></label>
