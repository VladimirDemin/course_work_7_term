   ...
   protected void Page_Load(object sender, EventArgs e)
{
    if (!IsPostBack)
    {
        ...
        // Проверяем, существует ли значение перед установкой
        ...
        {
            // Устанавливаем значение по умолчанию, если year отсутствует
            ddlYear.SelectedIndex = 0;
        }

        if (ddlMonth.Items.FindByValue(month) != null)
        {
            ddlMonth.SelectedValue = month;
        }
        else
        {
            // Устанавливаем значение по умолчанию, если month отсутствует
